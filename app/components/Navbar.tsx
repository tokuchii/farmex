  ...
  return (
    <nav
      className={`fixed w-full top-0 left-0 z-50 transition-all duration-300 ${
        scrolled
          ? "bg-white/20 backdrop-blur-lg shadow-none"
          : "bg-white shadow-[0_8px_40px_0_rgba(0,0,0,0.45)]"
      }`}
    >
...
<div
  className="relative"
  ref={servicesRef}
  onMouseEnter={() => setOpenDropdownDesktop("services")}
  onMouseLeave={() => setOpenDropdownDesktop(null)}
>
  <button className="text-black hover:text-green-600 font-medium focus:outline-none">
    Services
  </button>

  {openDropdownDesktop === "services" && (
    <div className="absolute left-0 top-full pt-2 z-50">
      <div className="w-48 bg-white border rounded shadow-lg overflow-hidden">
...
<div
  className="relative"
  ref={knowledgeRef}
  onMouseEnter={() => setOpenDropdownDesktop("knowledge")}
  onMouseLeave={() => setOpenDropdownDesktop(null)}
>
  <button className="text-black hover:text-green-600 font-medium focus:outline-none">
    Knowledge Transfer
  ...
  {openDropdownDesktop === "knowledge" && (
    <div className="absolute left-0 top-full pt-2 z-50">
      <div className="w-56 bg-white border rounded shadow-lg overflow-hidden">
        ...
        {/* Mobile Menu */}
        <div
          className={`[@media(max-width:1002px)]:block hidden fixed top-16 left-0 w-full z-60 bg-white shadow-lg transition-transform duration-300 ${
            menuOpen
