...
const newsSlides: Record<number, { src: string; alt: string }[]> = {
  ...
  3: [{ src: "/news4 1_copy.webp", alt: "RiceBoard Elects New Officers for 2025–2026" }],
  4: [{ src: "/news5 1_copy.webp", alt: "USDA Visits LAV for Rice Industry Discussion" }],
  5: [
