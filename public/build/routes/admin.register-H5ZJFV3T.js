...
import {
  useAdminActionToast
} from "/build/_shared/chunk-H7DKSGHW.js";
import {
  useAdminUrlToast
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1779698062266.0278";
}
...
function AdminRegister() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(AdminAuthShell_default, { eyebrow: "Register", title: "Create admin account", description: "Create an admin account to access the panel.", footer: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { children: [
    "Have an account?",
    " ",
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: "/admin", className: "font-semibold text-emerald-600 transition hover:text-emerald-700", children: "Log in here" }, void 0, false, {
...
//# sourceMappingURL=/build/routes/admin.register-H5ZJFV3T.js.map
