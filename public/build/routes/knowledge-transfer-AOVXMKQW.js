...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1754414376553.0437";
}
var meta = () => [{
...
_s(KnowledgeTransfer, "k460N28PNzD7zo1YW47Q9UigQis=");
_c = KnowledgeTransfer;
function LAVStationSlider() {
  _s2();
  const images = [{
    src: "/LAV-station 2.png",
    alt: "LAV Station 2"
  }, {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "w-full flex flex-col items-center", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "relative w-full flex items-center justify-center", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { onClick: prev, className: "absolute left-0 z-10 bg-[#057A31] hover:bg-[#046a2a] text-white rounded-full w-10 h-10 md:w-12 md:h-12 flex items-center justify-center shadow-lg transition-colors duration-200 -ml-3 md:-ml-4", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "text-lg md:text-xl font-bold", children: "<" }, void 0, false, {
        fileName: "app/routes/knowledge-transfer.tsx",
        lineNumber: 140,
        columnNumber: 11
      }, this) }, void 0, false, {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { onClick: next, className: "absolute right-0 z-10 bg-[#057A31] hover:bg-[#046a2a] text-white rounded-full w-10 h-10 md:w-12 md:h-12 flex items-center justify-center shadow-lg transition-colors duration-200 -mr-3 md:-mr-4", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "text-lg md:text-xl font-bold", children: ">" }, void 0, false, {
        fileName: "app/routes/knowledge-transfer.tsx",
        lineNumber: 150,
        columnNumber: 11
      }, this) }, void 0, false, {
...
//# sourceMappingURL=/build/routes/knowledge-transfer-AOVXMKQW.js.map
