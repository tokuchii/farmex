...
import {
  Link,
  useLocation
} from "/build/_shared/chunk-7VV7PHEX.js";
import {
  Dialog,
  DialogContent,
  DialogHeader,
  DialogTitle
} from "/build/_shared/chunk-MK7LFFOG.js";
import {
  clsx_default
} from "/build/_shared/chunk-QHNS7JQF.js";
import "/build/_shared/chunk-2ELZTNL5.js";
...
function Services() {
  ...
  const trainingRanges = [{
    ...
    title: '"SKILLS TRAINING ON MECHANIZATION TO UPGRADE COPRA/CNO PROCESSING AND INTEGRATION OF HIGH VALUE CROPS CULTIVATION FOR PROFITABLE COOPERATIVE COCONUT-BASED AGRI-BUSINESS VENTURE."'
  }];
    ...
    activeSection === "rentals" && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(motion.div, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("section", { className: "w-full py-16 px-4 sm:px-8 bg-[url('/newbgmachinerental.png')] bg-cover bg-center flex flex-col items-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "w-full max-w-6xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-4 sm:gap-6 lg:gap-8", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(motion.div, { className: "overflow-hidden p-2 sm:p-3 lg:p-4", initial: {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "h-[280px] sm:h-[280px] md:h-[350px] lg:h-[450px] w-full overflow-hidden relative rounded py-2 sm:py-3 lg:py-4", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("img", { src: "/new_mobiledryer.png", alt: "Mobile Dryer", className: "w-full h-full object-cover border-2 sm:border-3 md:border-4 border-[#00703C] rounded-lg" }, void 0, false, {
            fileName: "app/routes/services.tsx",
            lineNumber: 211,
            columnNumber: 21
          }, this) }, void 0, false, {
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(motion.div, { className: "overflow-hidden p-2 sm:p-3 lg:p-4", initial: {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "h-[280px] sm:h-[280px] md:h-[350px] lg:h-[450px] w-full overflow-hidden relative rounded py-2 sm:py-3 lg:py-4", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("img", { src: "/new_tractor.jpeg", alt: "Tractor", className: "w-full h-full object-cover border-2 sm:border-3 md:border-4 border-[#00703C] rounded-lg" }, void 0, false, {
            fileName: "app/routes/services.tsx",
            lineNumber: 236,
            columnNumber: 21
          }, this) }, void 0, false, {
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(motion.div, { className: "overflow-hidden p-2 sm:p-3 lg:p-4", initial: {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "px-2 sm:px-4 pt-2 sm:pt-4", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h3", { className: "text-green-600 font-bold text-base sm:text-lg md:text-xl lg:text-2xl", children: "Vacuum Seeder" }, void 0, false, {
              fileName: "app/routes/services.tsx",
              lineNumber: 257,
              columnNumber: 21
            }, this),
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "h-[280px] sm:h-[280px] md:h-[350px] lg:h-[450px] w-full overflow-hidden relative rounded py-2 sm:py-3 lg:py-4", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("img", { src: "/vacuumseeder.jpg", className: "w-full h-full object-cover border-2 sm:border-3 md:border-4 border-[#00703C] rounded-lg" }, void 0, false, {
            fileName: "app/routes/services.tsx",
            lineNumber: 261,
            columnNumber: 21
          }, this) }, void 0, false, {
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(motion.div, { className: "overflow-hidden p-2 sm:p-3 lg:p-4", initial: {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "h-[280px] sm:h-[280px] md:h-[350px] lg:h-[450px] w-full overflow-hidden relative rounded py-2 sm:py-3 lg:py-4", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("img", { src: "/new_harvester.jpg", alt: "Harvester", className: "w-full h-full object-cover border-2 sm:border-3 md:border-4 border-[#00703C] rounded-lg" }, void 0, false, {
            fileName: "app/routes/services.tsx",
            lineNumber: 286,
            columnNumber: 21
          }, this) }, void 0, false, {
    ...
    activeSection === "training" && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(motion.div, { className: "relative w-full h-[600px] sm:h-[600px] md:h-[1000px] lg:h-[800px] overflow-hidden", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "absolute inset-0 flex flex-col items-center justify-center z-20 px-4 md:px-8 py-4 pt-24 md:pt-24", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h2", { className: "text-white text-3xl md:text-5xl lg:text-6xl font-extrabold tracking-widest mb-8 md:mb-12 text-center", children: "Trainings" }, void 0, false, {
            fileName: "app/routes/services.tsx",
            lineNumber: 355,
            columnNumber: 15
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "text-white text-[12px] md:text-lg lg:text-xl font-semibold leading-relaxed max-w-6xl mb-4 md:mb-8 text-justify", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { children: "As an LSA, we remain committed to helping Filipino farmers and agri-stakeholders across crop industries by providing relevant knowledge, field-based demonstrations, and hands-on training. We believe that continuous education not only improves productivity but also inspires the next generation to pursue and sustain the future of agriculture." }, void 0, false, {
              fileName: "app/routes/services.tsx",
              lineNumber: 362,
              columnNumber: 17
            }, this)
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-8 px-4 md:px-8 py-12 items-stretch", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "w-full order-2 lg:order-1", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "grid grid-cols-2 md:grid-cols-3 gap-4", children: [
            images.slice(0, 9).map((img, i) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "overflow-hidden rounded-2xl shadow-lg", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { onClick: () => {
              setSelectedImage(img);
              setIsImageOpen(true);
            }, className: "w-full h-full focus:outline-none", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(LazyLoadImage, { src: img.src, alt: img.alt, className: "w-full aspect-[4/3] object-cover hover:scale-105 transition-transform duration-300 cursor-pointer" }, void 0, false, {
              fileName: "app/routes/services.tsx",
              lineNumber: 381,
              columnNumber: 23
            }, this) }, void 0, false, {
            ...
            showMore && images.slice(9).map((img, i) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "overflow-hidden rounded-2xl shadow-lg", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { onClick: () => {
              setSelectedImage(img);
              setIsImageOpen(true);
            }, className: "w-full h-full focus:outline-none", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(LazyLoadImage, { src: img.src, alt: img.alt, className: "w-full aspect-[4/3] object-cover hover:scale-105 transition-transform duration-300 cursor-pointer" }, void 0, false, {
              fileName: "app/routes/services.tsx",
          ...
          images.length > 9 && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "mt-4 text-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { onClick: () => setShowMore(!showMore), className: "text-green-700 font-semibold hover:underline", children: showMore ? "Show Less" : "Show More" }, void 0, false, {
            fileName: "app/routes/services.tsx",
            lineNumber: 400,
            columnNumber: 19
          }, this) }, void 0, false, {
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "w-full order-1 lg:order-2", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "bg-gradient-to-br from-green-300 via-green-200 to-green-300 rounded-2xl shadow-lg p-4 w-full flex flex-col sticky top-24", children: [
          ...
          isClient && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "mt-6 px-4 md:px-8", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("ul", { className: "flex flex-col gap-3", children: trainingRanges.sort((a, b) => new Date(a.start).getTime() - new Date(b.start).getTime()).slice(0, showAll ? trainingRanges.length : 3).map((event, idx) => {
              const now = /* @__PURE__ */ new Date();
...
_s(Services, "rtyH3/H4Po4hFnJMZB3uoqqBAc8=", false, function() {
  return [useLocation];
});
_c = Services;
...
//# sourceMappingURL=/build/routes/services-V4AQXKYP.js.map
