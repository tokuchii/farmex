...
// empty-module:~/lib/visitors.server
var require_visitors = __commonJS({
  "empty-module:~/lib/visitors.server"(exports, module) {
    module.exports = {};
  }
});
  ...
  "node_modules/es-toolkit/dist/compat/util/toPath.js"(exports) {
    ...
    function toPath(deepKey) {
      if (Array.isArray(deepKey))
        return deepKey.map(require_toKey2.toKey);
...
var require_get = __commonJS({
  "node_modules/es-toolkit/dist/compat/object/get.js"(exports) {
    ...
    function get5(object, path2, defaultValue) {
      ...
      switch (typeof path2) {
        case "string": {
          if (require_isUnsafeProperty2.isUnsafeProperty(path2))
            return defaultValue;
          const result = object[path2];
          if (result === void 0)
            if (require_isDeepKey2.isDeepKey(path2))
              return get5(object, require_toPath2.toPath(path2), defaultValue);
            else
              return defaultValue;
          return result;
        }
        ...
        case "symbol": {
          if (typeof path2 === "number")
            path2 = require_toKey2.toKey(path2);
          const result = object[path2];
          if (result === void 0)
            return defaultValue;
          return result;
    ...
    function getWithPath(object, path2, defaultValue) {
      ...
      for (let index = 0; index < path2.length; index++) {
        if (current3 == null)
          return defaultValue;
        if (require_isUnsafeProperty2.isUnsafeProperty(path2[index]))
          return defaultValue;
...
var require_cloneDeepWith = __commonJS({
  "node_modules/es-toolkit/dist/object/cloneDeepWith.js"(exports) {
    ...
    var require_isTypedArray2 = require_isTypedArray();
    ...
    function cloneDeepWithImpl(valueToClone, keyToClone, objectToClone, stack = /* @__PURE__ */ new Map(), cloneValue = void 0) {
      ...
      if (cloned !== void 0)
        return cloned;
      if (require_isPrimitive2.isPrimitive(valueToClone))
        return valueToClone;
      ...
      if (require_isBuffer2.isBuffer(valueToClone))
        return valueToClone.subarray();
      if (require_isTypedArray2.isTypedArray(valueToClone)) {
  ...
  "node_modules/es-toolkit/dist/compat/predicate/isMatchWith.js"(exports) {
    ...
    function isMatchWithInternal(target, source, compare, stack) {
      ...
      switch (typeof source) {
        ...
        default:
          if (!require_isObject2.isObject(target))
            return require_isEqualsSameValueZero2.isEqualsSameValueZero(target, source);
    ...
    function isObjectMatch(target, source, compare, stack) {
      ...
      if (target == null || require_isPrimitive2.isPrimitive(target))
      ...
      try {
        for (let i = 0; i < keys.length; i++) {
          const key = keys[i];
          if (!require_isPrimitive2.isPrimitive(target) && !(key in target))
            return false;
...
var require_has = __commonJS({
  "node_modules/es-toolkit/dist/compat/object/has.js"(exports) {
    ...
    function has3(object, path2) {
      ...
      if (Array.isArray(path2))
        resolvedPath = path2;
      else if (typeof path2 === "string" && require_isDeepKey2.isDeepKey(path2) && object?.[path2] == null)
        resolvedPath = require_toPath2.toPath(path2);
      else
        resolvedPath = [path2];
      ...
      for (let i = 0; i < resolvedPath.length; i++) {
        ...
        if (current3 == null || !Object.hasOwn(current3, key)) {
          if (!((Array.isArray(current3) || require_isArguments2.isArguments(current3)) && require_isIndex2.isIndex(key) && key < current3.length))
            return false;
        }
  ...
  "node_modules/es-toolkit/dist/compat/predicate/matchesProperty.js"(exports) {
    ...
    function matchesProperty(property, source) {
      ...
      return function(target) {
        ...
        if (result === void 0)
          return require_has2.has(target, property);
        if (source === void 0)
...
var require_iteratee = __commonJS({
  "node_modules/es-toolkit/dist/compat/util/iteratee.js"(exports) {
    ...
    function iteratee(value) {
      if (value == null)
        return require_identity2.identity;
      switch (typeof value) {
        case "function":
          return value;
        case "object":
          if (Array.isArray(value) && value.length === 2)
            return require_matchesProperty2.matchesProperty(value[0], value[1]);
...
var require_uniqBy2 = __commonJS({
  "node_modules/es-toolkit/dist/compat/array/uniqBy.js"(exports) {
    ...
    function uniqBy2(array, iteratee$1 = require_identity2.identity) {
      if (!require_isArrayLikeObject2.isArrayLikeObject(array))
        return [];
      return require_uniqBy4.uniqBy(Array.from(array), require_ary2.ary(require_iteratee2.iteratee(iteratee$1), 1));
    }
    exports.uniqBy = uniqBy2;
  }
});
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React36 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is4, useSyncExternalStore2 = shim.useSyncExternalStore, useRef17 = React36.useRef, useEffect17 = React36.useEffect, useMemo11 = React36.useMemo, useDebugValue2 = React36.useDebugValue;
...
var require_isIterateeCall = __commonJS({
  "node_modules/es-toolkit/dist/compat/_internal/isIterateeCall.js"(exports) {
    ...
    function isIterateeCall(value, index, object) {
      if (!require_isObject2.isObject(object))
        return false;
      if (typeof index === "number" && require_isArrayLike2.isArrayLike(object) && require_isIndex2.isIndex(index) && index < object.length || typeof index === "string" && index in object)
        return require_isEqualsSameValueZero2.isEqualsSameValueZero(object[index], value);
      return false;
    }
...
var require_isKey = __commonJS({
  "node_modules/es-toolkit/dist/compat/_internal/isKey.js"(exports) {
    ...
    function isKey(value, object) {
      if (Array.isArray(value))
        return false;
      if (typeof value === "number" || typeof value === "boolean" || value == null || require_isSymbol2.isSymbol(value))
        return true;
  ...
  "node_modules/es-toolkit/dist/compat/array/orderBy.js"(exports) {
    ...
    function orderBy(collection, criteria, orders, guard) {
      ...
      const preparedCriteria = criteria.map((criterion) => {
        ...
        if (criterion == null || typeof criterion === "function" || Array.isArray(criterion) || require_isKey2.isKey(criterion))
          return criterion;
        return {
          key: criterion,
      ...
      return collection.map((item) => ({
        ...
        for (let i = 0; i < preparedCriteria.length; i++) {
          const comparedResult = require_compareValues2.compareValues(a.criteria[i], b.criteria[i], orders[i]);
          if (comparedResult !== 0)
...
var require_sortBy = __commonJS({
  "node_modules/es-toolkit/dist/compat/array/sortBy.js"(exports) {
    var require_flatten2 = require_flatten();
    ...
    function sortBy6(collection, ...criteria) {
      ...
      if (length > 1 && require_isIterateeCall2.isIterateeCall(collection, criteria[0], criteria[1]))
        criteria = [];
      else if (length > 2 && require_isIterateeCall2.isIterateeCall(criteria[0], criteria[1], criteria[2]))
        criteria = [criteria[0]];
      return require_orderBy2.orderBy(collection, require_flatten2.flatten(criteria), ["asc"]);
    }
...
var require_use_sync_external_store_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React36 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is4, useSyncExternalStore2 = React36.useSyncExternalStore, useRef17 = React36.useRef, useEffect17 = React36.useEffect, useMemo11 = React36.useMemo, useDebugValue2 = React36.useDebugValue;
      exports.useSyncExternalStoreWithSelector = function(subscribe, getSnapshot, getServerSnapshot, selector, isEqual) {
        var instRef = useRef17(null);
        if (null === instRef.current) {
          var inst = { hasValue: false, value: null };
...
var require_toNumber = __commonJS({
  "node_modules/es-toolkit/dist/compat/util/toNumber.js"(exports) {
    ...
    function toNumber(value) {
      if (require_isSymbol2.isSymbol(value))
        return NaN;
      return Number(value);
    }
...
var require_range = __commonJS({
  "node_modules/es-toolkit/dist/compat/math/range.js"(exports) {
    ...
    function range3(start, end, step) {
      if (step && typeof step !== "number" && require_isIterateeCall2.isIterateeCall(start, end, step))
        end = step = void 0;
      ...
      if (end === void 0) {
        ...
        end = require_toFinite2.toFinite(end);
...
function executeReducerBuilderCallback(builderCallback) {
  ...
  const builder = {
    ...
    addAsyncThunk(asyncThunk, reducers2) {
      ...
      if (reducers2.pending)
        actionsMap[asyncThunk.pending.type] = reducers2.pending;
      if (reducers2.rejected)
        actionsMap[asyncThunk.rejected.type] = reducers2.rejected;
      if (reducers2.fulfilled)
        actionsMap[asyncThunk.fulfilled.type] = reducers2.fulfilled;
...
var DefaultTooltipContent = (props) => {
  ...
  var renderContent2 = () => {
    if (payload && payload.length) {
      ...
      var items = sortedPayload.map((entry, i) => {
        ...
        var finalItemStyle = _objectSpread5(_objectSpread5({}, defaultDefaultTooltipContentProps.itemStyle), {}, {
  ...
  var finalStyle = _objectSpread5(_objectSpread5({}, defaultDefaultTooltipContentProps.contentStyle), contentStyle);
  ...
  return /* @__PURE__ */ React6.createElement("div", _extends4({
    className: wrapperCN,
    style: finalStyle
...
function TooltipBoundingBoxImpl(props) {
  ...
  var [state, setState] = React7.useState(() => ({
    dismissed: false,
  ...
  if (state.dismissed && (((_props$coordinate$x2 = (_props$coordinate5 = props.coordinate) === null || _props$coordinate5 === void 0 ? void 0 : _props$coordinate5.x) !== null && _props$coordinate$x2 !== void 0 ? _props$coordinate$x2 : 0) !== state.dismissedAtCoordinate.x || ((_props$coordinate$y2 = (_props$coordinate6 = props.coordinate) === null || _props$coordinate6 === void 0 ? void 0 : _props$coordinate6.y) !== null && _props$coordinate$y2 !== void 0 ? _props$coordinate$y2 : 0) !== state.dismissedAtCoordinate.y)) {
    setState(_objectSpread6(_objectSpread6({}, state), {}, {
      dismissed: false
    }));
  }
  var {
  ...
  var positionStyle = props.hasPortalFromProps ? {} : _objectSpread6(_objectSpread6({
  ...
  var outerStyle = _objectSpread6(_objectSpread6({}, positionStyle), {}, {
...
var TooltipBoundingBox = /* @__PURE__ */ React7.memo(TooltipBoundingBoxImpl);
...
var Curve = (props) => {
  ...
  return /* @__PURE__ */ React8.createElement("path", _extends5({}, svgPropertiesNoEvents(props), adaptEventHandlers(props), {
...
var Cross = (_ref2) => {
  ...
  return /* @__PURE__ */ React9.createElement("path", _extends6({}, svgPropertiesAndEvents(props), {
...
var Rectangle = (rectangleProps) => {
  ...
  if (!isUpdateAnimationActive) {
    ...
    return /* @__PURE__ */ React10.createElement("path", _extends7({}, otherPathProps, {
      x: round(x2),
      y: round(y2),
      width: round(width),
      height: round(height),
  ...
  return /* @__PURE__ */ React10.createElement(JavascriptAnimate, {
    ...
    return /* @__PURE__ */ React10.createElement("path", _extends7({}, otherPathProps2, {
      radius: typeof radius === "number" ? radius : void 0,
      className: layerClass,
...
var Sector = (sectorProps) => {
  ...
  return /* @__PURE__ */ React11.createElement("path", _extends8({}, svgPropertiesAndEvents(props), {
    className: layerClass,
    d: path2
  }));
};
...
var Text = /* @__PURE__ */ (0, import_react22.forwardRef)((outsideProps, ref) => {
  ...
  return /* @__PURE__ */ React14.createElement("text", _extends10({}, svgPropertiesAndEvents(textProps), {
    ref,
    x: x2,
    y: y2,
...
function Label(outerProps) {
  ...
  if (typeof content === "function") {
    var {
      content: _2
    } = propsWithViewBox, propsForContent = _objectWithoutProperties7(propsWithViewBox, _excluded24);
  ...
  if (isPolar(viewBox)) {
    ...
    positionAttrs = _objectSpread25(_objectSpread25({
      x: cartesianResult.x,
      y: cartesianResult.y,
  ...
  return /* @__PURE__ */ React15.createElement(ZIndexLayer, {
    zIndex: props.zIndex
  }, /* @__PURE__ */ React15.createElement(Text, _extends11({
    ref: labelRef,
...
var parseLabel = (label, viewBox, labelRef) => {
  ...
  if (/* @__PURE__ */ (0, import_react23.isValidElement)(label)) {
    if (label.type === Label) {
      return /* @__PURE__ */ (0, import_react23.cloneElement)(label, _objectSpread25({
        key: "label-implicit"
      }, commonProps));
    }
    return /* @__PURE__ */ React15.createElement(Label, _extends11({
...
function LabelList(_ref2) {
  ...
  var {
    ...
    textBreakAll,
    zIndex
  } = restProps, others = _objectWithoutProperties8(restProps, _excluded25);
...
var Dot = (props) => {
  ...
  if (isNumber(cx) && isNumber(cy) && isNumber(r)) {
    return /* @__PURE__ */ React17.createElement("circle", _extends13({}, svgPropertiesNoEvents(props), adaptEventHandlers(props), {
      className: layerClass,
      cx,
      cy,
      r
...
function SetTooltipEntrySettings(_ref2) {
  ...
  var dispatch = useAppDispatch();
  var isPanorama = useIsPanorama();
  var prevSettingsRef = (0, import_react26.useRef)(null);
...
function SetLegendPayload(_ref2) {
  ...
  var dispatch = useAppDispatch();
  var isPanorama = useIsPanorama();
  var prevPayloadRef = (0, import_react27.useRef)(null);
...
var _ref;
var useIdFallback = () => {
  var [id] = React18.useState(() => uniqueId("uid-"));
  return id;
};
var useId = (_ref = React18["useId".toString()]) !== null && _ref !== void 0 ? _ref : useIdFallback;
...
var RegisterGraphicalItemId = (_ref2) => {
  ...
  return /* @__PURE__ */ React19.createElement(GraphicalItemIdContext.Provider, {
    value: resolvedId
  }, children(resolvedId));
};
...
function DotItem(_ref2) {
  ...
  if (/* @__PURE__ */ (0, import_react30.isValidElement)(option)) {
    return /* @__PURE__ */ (0, import_react30.cloneElement)(option, dotProps);
  }
  if (typeof option === "function") {
  ...
  return /* @__PURE__ */ React20.createElement(Dot, _extends14({}, props, {
...
function Dots(_ref3) {
  ...
  var dots = points.map((entry, i) => {
    ...
    var dotProps = _objectSpread26(_objectSpread26(_objectSpread26({
      r: 3
    ...
    return /* @__PURE__ */ React20.createElement(DotItem, {
      key: "dot-".concat(i),
      option: dot,
      dotProps,
  ...
  return /* @__PURE__ */ React20.createElement(ZIndexLayer, {
    zIndex
  }, /* @__PURE__ */ React20.createElement(Layer, _extends14({
    className
  }, layerProps), dots));
}
  ...
  reducers: {
    ...
    updateYAxisWidth(state, action) {
      ...
      if (axis) {
        ...
        state.yAxis[id] = _objectSpread27(_objectSpread27({}, axis), {}, {
          width,
...
var ActivePoint = (_ref2) => {
  ...
  var dotProps = _objectSpread28(_objectSpread28(_objectSpread28({}, dotPropsTyped), svgPropertiesNoEventsFromUnknown(activeDot)), adaptEventHandlers(activeDot));
  var dot;
  if (/* @__PURE__ */ (0, import_react31.isValidElement)(activeDot)) {
    dot = /* @__PURE__ */ (0, import_react31.cloneElement)(activeDot, dotProps);
  } else if (typeof activeDot === "function") {
    dot = activeDot(dotProps);
  } else {
    dot = /* @__PURE__ */ React21.createElement(Dot, dotProps);
  }
...
function ActivePoints(_ref2) {
  ...
  return /* @__PURE__ */ React21.createElement(ZIndexLayer, {
    zIndex
  }, /* @__PURE__ */ React21.createElement(ActivePoint, {
    point: activePoint,
...
// node_modules/recharts/es6/cartesian/CartesianAxis.js
var _excluded10 = ["axisLine", "width", "height", "className", "hide", "ticks", "axisType", "axisId"];
...
function TickItem(props) {
  ...
  if (/* @__PURE__ */ React23.isValidElement(option)) {
    tickItem = /* @__PURE__ */ React23.cloneElement(option, _objectSpread30(_objectSpread30({}, tickProps), {}, {
...
var Ticks = /* @__PURE__ */ (0, import_react34.forwardRef)((props, ref) => {
  ...
  var tickLabels = tickLineCoords.map((_ref3, i) => {
    ...
    var finalTickProps = _objectSpread30(_objectSpread30({}, tickProps), customTickProps);
...
function LineItem(_ref2) {
  ...
  if (/* @__PURE__ */ React24.isValidElement(option)) {
    ...
    var _ref22 = (_svgPropertiesNoEvent = svgPropertiesNoEvents(others)) !== null && _svgPropertiesNoEvent !== void 0 ? _svgPropertiesNoEvent : {}, {
      offset: __
    } = _ref22, restOfFilteredProps = _objectWithoutProperties11(_ref22, _excluded26);
...
function GraphicalItemClipPath(_ref2) {
  ...
  return /* @__PURE__ */ React25.createElement("clipPath", {
...
var SetAreaTooltipEntrySettings = /* @__PURE__ */ React26.memo((_ref2) => {
  var {
    dataKey,
    data,
    stroke,
...
function AreaDotsWrapper(_ref2) {
  ...
  return /* @__PURE__ */ React26.createElement(Dots, {
    points,
    dot,
...
function AreaLabelListProvider(_ref3) {
  ...
  return /* @__PURE__ */ React26.createElement(CartesianLabelListContextProvider, {
...
function StaticArea(_ref4) {
  ...
  return /* @__PURE__ */ React26.createElement(React26.Fragment, null, (points === null || points === void 0 ? void 0 : points.length) > 1 && /* @__PURE__ */ React26.createElement(Layer, {
  ...
  }, /* @__PURE__ */ React26.createElement(Curve, _extends17({}, propsWithEvents, {
    id,
    points,
    connectNulls,
    type,
  ...
  })), stroke !== "none" && /* @__PURE__ */ React26.createElement(Curve, _extends17({}, allOtherProps, {
    ...
    fill: "none",
    points
  })), stroke !== "none" && isRange && Array.isArray(baseLine) && /* @__PURE__ */ React26.createElement(Curve, _extends17({}, allOtherProps, {
    className: "recharts-area-curve",
    layout,
    type,
    connectNulls,
    fill: "none",
    points: baseLine
  }))), /* @__PURE__ */ React26.createElement(AreaDotsWrapper, {
    points,
...
function AreaWithAnimation(_ref8) {
  ...
  var animationInput = (0, import_react35.useMemo)(() => ({
    points,
    baseLine
  }), [points, baseLine]);
  ...
  return /* @__PURE__ */ React26.createElement(AreaLabelListProvider, {
    showLabels,
    points
  }, props.children, /* @__PURE__ */ React26.createElement(JavascriptAnimate, {
    animationId,
    begin: animationBegin,
    duration: animationDuration,
    ...
    return /* @__PURE__ */ React26.createElement(Layer, null, isAnimationActive && /* @__PURE__ */ React26.createElement("defs", null, /* @__PURE__ */ React26.createElement("clipPath", {
  ...
  }), /* @__PURE__ */ React26.createElement(LabelListFromLabelProp, {
    label: props.label
  }));
}
function RenderArea(_ref9) {
  ...
  var previousPointsRef = (0, import_react35.useRef)(null);
  var previousBaselineRef = (0, import_react35.useRef)();
...
var AreaWithState = class extends import_react35.PureComponent {
  render() {
    var {
      hide,
      dot,
...
function AreaImpl(props) {
  ...
  var {
    ...
    xAxisId,
    yAxisId
  } = props, everythingElse = _objectWithoutProperties12(props, _excluded27);
  var layout = useChartLayout();
  var chartName = useChartName();
  var {
    needClip
  ...
  return /* @__PURE__ */ React26.createElement(AreaWithState, _extends17({}, everythingElse, {
    activeDot,
    animationBegin,
    animationDuration,
    animationEasing,
...
function AreaFn(outsideProps) {
  ...
  return /* @__PURE__ */ React26.createElement(RegisterGraphicalItemId, {
    id: props.id,
    type: "area"
  }, (id) => /* @__PURE__ */ React26.createElement(React26.Fragment, null, /* @__PURE__ */ React26.createElement(SetLegendPayload, {
    legendPayload: computeLegendPayloadFromAreaData(props)
  }), /* @__PURE__ */ React26.createElement(SetAreaTooltipEntrySettings, {
    ...
    id
  }), /* @__PURE__ */ React26.createElement(SetCartesianGraphicalItem, {
    type: "area",
    id,
    data: props.data,
    dataKey: props.dataKey,
    ...
    isPanorama,
    connectNulls: props.connectNulls
  }), /* @__PURE__ */ React26.createElement(AreaImpl, _extends17({}, props, {
    id
  }))));
}
...
function axisPropsAreEqual(prevProps, nextProps) {
  ...
  var {
    domain: nextDomain,
    range: nextRange
  } = nextProps, nextRest = _objectWithoutProperties13(nextProps, _excluded28);
...
var XAxisImpl = (props) => {
  ...
  var {
    ...
    ticks: ticks2,
    scale: del
  } = props, allOtherProps = _objectWithoutProperties14(props, _excluded29);
  var {
    id,
    scale: del2
  } = synchronizedSettings, restSynchronizedSettings = _objectWithoutProperties14(synchronizedSettings, _excluded33);
  return /* @__PURE__ */ React27.createElement(CartesianAxis, _extends18({}, allOtherProps, restSynchronizedSettings, {
    x: position.x,
    y: position.y,
...
function SetYAxisSettings(props) {
  ...
  var {
    type: typeFromProps
  } = props, restProps = _objectWithoutProperties15(props, _excluded15);
...
function YAxisImpl(props) {
  ...
  var {
    ...
    ticks: ticks2,
    scale: del
  } = props, allOtherProps = _objectWithoutProperties15(props, _excluded210);
  var {
    id,
    scale: del2
  } = synchronizedSettings, restSynchronizedSettings = _objectWithoutProperties15(synchronizedSettings, _excluded34);
...
function RechartsStoreProvider(_ref2) {
  ...
  return /* @__PURE__ */ React29.createElement(Provider_default, {
...
function AllZIndexPortals(_ref2) {
  ...
  return /* @__PURE__ */ React30.createElement(React30.Fragment, null, allNegativeZIndexes.map((zIndex) => /* @__PURE__ */ React30.createElement(ZIndexSvgPortal, {
    key: zIndex,
    zIndex,
    isPanorama
  })), children, allPositiveZIndexes.map((zIndex) => /* @__PURE__ */ React30.createElement(ZIndexSvgPortal, {
    key: zIndex,
    zIndex,
    isPanorama
  })));
...
var MainChartSurface = /* @__PURE__ */ (0, import_react43.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ React31.createElement(Surface, _extends20({}, otherAttributes, {
    title,
    desc,
    role,
    tabIndex,
...
var RootSurface = /* @__PURE__ */ (0, import_react43.forwardRef)((_ref2, ref) => {
  ...
  var isPanorama = useIsPanorama();
  if (isPanorama) {
    return /* @__PURE__ */ React31.createElement(BrushPanoramaSurface, null, /* @__PURE__ */ React31.createElement(AllZIndexPortals, {
      isPanorama: true
    }, children));
  }
  return /* @__PURE__ */ React31.createElement(MainChartSurface, _extends20({
    ref
  }, rest), /* @__PURE__ */ React31.createElement(AllZIndexPortals, {
    isPanorama: false
  }, children));
});
...
function useReportScale() {
  var dispatch = useAppDispatch();
  var [ref, setRef] = (0, import_react44.useState)(null);
...
var ResponsiveDiv = /* @__PURE__ */ (0, import_react45.forwardRef)((props, ref) => {
  ...
  var [sizes, setSizes] = (0, import_react45.useState)({
  ...
  return /* @__PURE__ */ React32.createElement(React32.Fragment, null, /* @__PURE__ */ React32.createElement(ReportChartSize, {
    width: sizes.containerWidth,
    height: sizes.containerHeight
  }), /* @__PURE__ */ React32.createElement("div", _extends21({
    ref: innerRef
  }, props)));
});
...
var NonResponsiveDiv = /* @__PURE__ */ (0, import_react45.forwardRef)((props, ref) => {
  ...
  if (typeof width === "string" || typeof height === "string") {
    return /* @__PURE__ */ React32.createElement(ReadSizeOnceDiv, _extends21({}, props, {
      ref
    }));
  }
  if (typeof width === "number" && typeof height === "number") {
    return /* @__PURE__ */ React32.createElement(StaticDiv, _extends21({}, props, {
      width,
      height,
      ref
    }));
...
var RechartsWrapper = /* @__PURE__ */ (0, import_react45.forwardRef)((props, ref) => {
  ...
  var dispatch = useAppDispatch();
  var [tooltipPortal, setTooltipPortal] = (0, import_react45.useState)(null);
  var [legendPortal, setLegendPortal] = (0, import_react45.useState)(null);
  ...
  return /* @__PURE__ */ React32.createElement(TooltipPortalContext.Provider, {
    ...
    value: legendPortal
  }, /* @__PURE__ */ React32.createElement(WrapperDiv, {
...
var defaultCartesianChartProps = _objectSpread36({
  accessibilityLayer: true,
  barCategoryGap: "10%",
  barGap: 4,
  layout: "horizontal",
...
var CartesianChart = /* @__PURE__ */ (0, import_react47.forwardRef)(function CartesianChart2(props, ref) {
  ...
  }), /* @__PURE__ */ React34.createElement(ReportEventSettings, {
  ...
  }), /* @__PURE__ */ React34.createElement(CategoricalChart, _extends22({}, rootChartProps, {
    ref
  })));
});
...
var AreaChart = /* @__PURE__ */ (0, import_react48.forwardRef)((props, ref) => {
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1782716050929.8591";
}
...
var visitors = await (0, import_visitors.getVisitorSessions)();
var visitorChartData = Object.values(visitors.reduce((acc, visitor) => {
  const date2 = new Date(visitor.createdAt).toLocaleDateString("en-US", {
    month: "short",
    day: "numeric"
  });
  if (!acc[date2]) {
...
var AdminDashboard = () => {
  ...
  const {
    user,
    totals,
    visitorChartData: visitorChartData2
  } = useLoaderData();
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("section", { className: "space-y-6 rounded-3xl border border-slate-200 bg-white p-8 shadow-xl shadow-slate-900/5", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-50 via-white to-emerald-50/30 p-6 shadow-lg shadow-emerald-100/50", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "mt-1 text-sm text-slate-500", children: "Daily visitor trends and engagement metrics" }, void 0, false, {
            fileName: "app/routes/admin.dashboard.tsx",
            lineNumber: 133,
            columnNumber: 13
          }, this)
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "mt-8", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "h-[400px] rounded-2xl bg-white p-4", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(AreaChart, { data: visitorChartData2, margin: {
        top: 10,
        right: 30,
        left: 0,
        bottom: 0
      }, children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("defs", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("linearGradient", { id: "colorVisitors", x1: "0", y1: "0", x2: "0", y2: "1", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("stop", { offset: "5%", stopColor: "#10b981", stopOpacity: 0.3 }, void 0, false, {
            fileName: "app/routes/admin.dashboard.tsx",
            lineNumber: 155,
            columnNumber: 21
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("stop", { offset: "95%", stopColor: "#10b981", stopOpacity: 0 }, void 0, false, {
            fileName: "app/routes/admin.dashboard.tsx",
            lineNumber: 156,
            columnNumber: 21
          }, this)
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(CartesianGrid, { strokeDasharray: "3 3", stroke: "#e2e8f0", vertical: false }, void 0, false, {
          fileName: "app/routes/admin.dashboard.tsx",
          lineNumber: 159,
          columnNumber: 17
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(XAxis, { dataKey: "date", stroke: "#94a3b8", style: {
          fontSize: "12px"
        } }, void 0, false, {
          fileName: "app/routes/admin.dashboard.tsx",
          lineNumber: 160,
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(YAxis, { allowDecimals: false, stroke: "#94a3b8", style: {
          fontSize: "12px"
        } }, void 0, false, {
          fileName: "app/routes/admin.dashboard.tsx",
          lineNumber: 163,
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Tooltip, { contentStyle: {
          ...
          color: "#f1f5f9"
        }, formatter: (value) => [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "font-semibold text-emerald-400", children: [
          value,
          " visitors"
        ] }, "value", true, {
          fileName: "app/routes/admin.dashboard.tsx",
          lineNumber: 173,
          columnNumber: 39
        }, this)], labelFormatter: (label) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "text-slate-300", children: label }, void 0, false, {
          fileName: "app/routes/admin.dashboard.tsx",
          lineNumber: 175,
          columnNumber: 56
        }, this) }, void 0, false, {
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Area, { type: "monotone", dataKey: "visitors", stroke: "#10b981", strokeWidth: 3, fill: "url(#colorVisitors)", dot: {
          fill: "#10b981",
          r: 5,
          strokeWidth: 2,
          stroke: "#fff"
          ...
          stroke: "#fff",
          strokeWidth: 2
        }, isAnimationActive: true }, void 0, false, {
          fileName: "app/routes/admin.dashboard.tsx",
          lineNumber: 176,
          columnNumber: 17
        }, this)
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "mt-6 grid grid-cols-3 gap-4", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "rounded-2xl bg-emerald-50 p-4", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "text-xs font-semibold uppercase tracking-wide text-emerald-700", children: "Total Visitors" }, void 0, false, {
            fileName: "app/routes/admin.dashboard.tsx",
            lineNumber: 194,
            columnNumber: 13
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "mt-2 text-2xl font-bold text-emerald-900", children: visitorChartData2.reduce((sum, day) => sum + day.visitors, 0) }, void 0, false, {
            fileName: "app/routes/admin.dashboard.tsx",
            lineNumber: 197,
            columnNumber: 13
          }, this)
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "rounded-2xl bg-blue-50 p-4", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "text-xs font-semibold uppercase tracking-wide text-blue-700", children: "Average Daily" }, void 0, false, {
            fileName: "app/routes/admin.dashboard.tsx",
            lineNumber: 202,
            columnNumber: 13
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "mt-2 text-2xl font-bold text-blue-900", children: Math.round(visitorChartData2.reduce((sum, day) => sum + day.visitors, 0) / visitorChartData2.length || 0) }, void 0, false, {
            fileName: "app/routes/admin.dashboard.tsx",
            lineNumber: 205,
            columnNumber: 13
          }, this)
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "rounded-2xl bg-purple-50 p-4", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "text-xs font-semibold uppercase tracking-wide text-purple-700", children: "Peak Day" }, void 0, false, {
            fileName: "app/routes/admin.dashboard.tsx",
            lineNumber: 210,
            columnNumber: 13
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "mt-2 text-2xl font-bold text-purple-900", children: Math.max(...visitorChartData2.map((day) => day.visitors), 0) }, void 0, false, {
            fileName: "app/routes/admin.dashboard.tsx",
            lineNumber: 213,
            columnNumber: 13
          }, this)
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=/build/routes/admin.dashboard-HYVMWSLN.js.map
