...
import {
  ...
  DialogHeader,
  DialogTitle
} from "/build/_shared/chunk-P3AQQ2T2.js";
import {
  clsx_default
...
function TechnicalConsultationSlider() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "w-full flex flex-col items-center", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex items-center justify-center w-full px-2 sm:px-4", onTouchStart: handleTouchStart, onTouchMove: handleTouchMove, onTouchEnd: handleTouchEnd, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("img", { src: images[index].src, alt: images[index].alt, className: "w-full max-w-[260px] sm:max-w-md md:max-w-lg lg:max-w-4xl h-56 sm:h-80 md:h-[350px] lg:h-[550px] object-cover rounded-lg mx-1 sm:mx-4 border-2 border-gray-200 bg-white" }, void 0, false, {
        fileName: "app/routes/services.tsx",
        lineNumber: 574,
        columnNumber: 9
      }, this),
...
//# sourceMappingURL=/build/routes/services-SSPNOWPZ.js.map
