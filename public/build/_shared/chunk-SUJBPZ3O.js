...
// empty-module:~/lib/firebase.server
var require_firebase = __commonJS({
  "empty-module:~/lib/firebase.server"(exports, module) {
    module.exports = {};
  }
});
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1779410954296.084";
}
...
var AdminAuthShell = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("main", { className: "flex min-h-screen items-center justify-center bg-slate-50 px-4 py-10 sm:py-14", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "w-full max-w-md space-y-8", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "text-center text-xs text-slate-400", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: "/", className: "font-medium text-emerald-600 transition hover:text-emerald-700", children: "Back to homepage" }, void 0, false, {
      fileName: "app/components/admin/AdminAuthShell.tsx",
      lineNumber: 76,
      columnNumber: 11
    }, this) }, void 0, false, {
...
(function() {
  ...
  h.j = function(d) {
    if (C2(this) || C2(d))
      return w;
    if (B(this))
      return B(d) ? x2(this).j(x2(d)) : x2(x2(this).j(d));
    if (B(d))
...
(function() {
  ...
  function Ka(a, b2, c, d, e) {
    ...
    c = Ma(c);
    return a && a[B] ? a.J(b2, c, n(d) ? !!d.capture : !!d, e) : Na(a, b2, c, false, d, e);
  }
  ...
  function La(a, b2, c, d, e) {
    ...
    c = Ma(c);
    return a && a[B] ? a.K(b2, c, n(d) ? !!d.capture : !!d, e) : Na(a, b2, c, true, d, e);
  }
  function Sa(a, b2, c, d, e) {
    if (Array.isArray(b2))
      ...
      (d = n(d) ? !!d.capture : !!d, c = Ma(c), a && a[B]) ? (a = a.i, f = String(b2).toString(), f in a.g && (b2 = a.g[f], c = Fa(b2, c, d, e), c > -1 && (xa(b2[c]), Array.prototype.splice.call(b2, c, 1), b2.length == 0 && (delete a.g[f], a.h--)))) : a && (a = Oa(a)) && (b2 = a.g[b2.toString()], a = -1, b2 && (a = Fa(b2, c, d, e)), (c = a > -1 ? b2[a] : null) && Ta(c));
  }
  function Ta(a) {
...
var DocumentSnapshot = class extends DocumentSnapshot$1 {
  ...
  toJSON() {
    ...
    if (e.type = DocumentSnapshot._jsonSchemaVersion, e.bundle = "", e.bundleSource = "DocumentSnapshot", e.bundleName = this._key.toString(), !t || !t.isValidDocument() || !t.isFoundDocument())
      return e;
...
@firebase/firestore/dist/index.esm.js:
   ...
   *)
*/
//# sourceMappingURL=/build/_shared/chunk-SUJBPZ3O.js.map
