...
var DialogOverlay2 = React25.forwardRef(_c = ({
  className,
  ...props
}, ref) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Overlay, { ref, className: cn("fixed inset-0 z-50 bg-black/50 backdrop-blur-sm data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:pointer-events-none", className), ...props }, void 0, false, {
...
var DialogTitle2 = React25.forwardRef(_c7 = ({
  className,
  ...props
}, ref) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Title, { ref, className: cn("text-lg font-semibold leading-none tracking-tight text-green-500", className), ...props }, void 0, false, {
  fileName: "app/components/ui/dialog.tsx",
  lineNumber: 70,
  columnNumber: 12
}, this));
...
//# sourceMappingURL=/build/_shared/chunk-NPIM253G.js.map
