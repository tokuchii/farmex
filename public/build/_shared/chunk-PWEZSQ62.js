...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1779679520272.2124";
}
var EMPTY_LIST_ITEM = "";
var formatDate = (iso) => {
  if (!iso)
...
var LavStationModule = ({
  ...
  (0, import_react.useEffect)(() => {
    ...
    if (wasSubmitting.current && fetcher.state === "idle") {
      ...
      if (fetcher.data?.ok) {
        ...
        if (submittedIntent === "create-lav-station" || submittedIntent === "update-lav-station") {
          setModalOpen(false);
          resetForm();
        }
      }
  ...
  const columns = [{
    ...
    cell: (row) => /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "flex flex-wrap gap-2", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("button", { type: "button", onClick: () => openEditModal(row), disabled: isBusy, className: "inline-flex items-center gap-1 rounded-xl border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 transition hover:bg-slate-50 disabled:opacity-60", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Pencil, { className: "h-3.5 w-3.5" }, void 0, false, {
          fileName: "app/components/admin/LavStationModule.tsx",
          lineNumber: 269,
          columnNumber: 13
        }, this),
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("button", { type: "button", onClick: () => handleDelete(row.id), disabled: isBusy, className: "inline-flex items-center gap-1 rounded-xl border border-rose-200 bg-rose-50 px-3 py-1.5 text-xs font-semibold text-rose-700 transition hover:bg-rose-100 disabled:opacity-60", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Trash2, { className: "h-3.5 w-3.5" }, void 0, false, {
          fileName: "app/components/admin/LavStationModule.tsx",
          lineNumber: 273,
          columnNumber: 13
        }, this),
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("section", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(AdminPaginatedTable_default, { columns, data: stations, getRowKey: (row) => row.id, isLoading: fetcher.state === "loading", emptyMessage: 'No lav stations yet. Use "Add lav station" to create one.', itemLabel: "lav stations", pagination: {
      pageSize: 5
    } }, void 0, false, {
      fileName: "app/components/admin/LavStationModule.tsx",
      lineNumber: 296,
...
_s(LavStationModule, "OYkXx+oWDCAZwuzxcyOdyYIwPd0=", false, function() {
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1779679517222.7231";
}
...
var RiceDerbiesModule = ({
  ...
  (0, import_react2.useEffect)(() => {
    ...
    if (wasSubmitting.current && fetcher.state === "idle") {
      ...
      if (fetcher.data?.ok) {
        toast.success(fetcher.data.message ?? "Updated successfully.");
        const submittedIntent = fetcherFormData?.get("intent");
        if (submittedIntent === "create-rice-derbies" || submittedIntent === "update-rice-derbies") {
          setModalOpen(false);
          resetForm();
        }
      }
  ...
  const handleDelete = (id) => {
    if (!confirm("Delete this rice derbies entry?"))
      return;
    fetcher.submit({
  ...
  const columns = [{
    ...
    cell: (row) => /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "flex flex-wrap gap-2", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("button", { type: "button", onClick: () => openEditModal(row), disabled: isBusy, className: "inline-flex items-center gap-1 rounded-xl border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 transition hover:bg-slate-50 disabled:opacity-60", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(Pencil, { className: "h-3.5 w-3.5" }, void 0, false, {
          fileName: "app/components/admin/RiceDerbiesModule.tsx",
          lineNumber: 269,
          columnNumber: 13
        }, this),
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("button", { type: "button", onClick: () => handleDelete(row.id), disabled: isBusy, className: "inline-flex items-center gap-1 rounded-xl border border-rose-200 bg-rose-50 px-3 py-1.5 text-xs font-semibold text-rose-700 transition hover:bg-rose-100 disabled:opacity-60", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(Trash2, { className: "h-3.5 w-3.5" }, void 0, false, {
          fileName: "app/components/admin/RiceDerbiesModule.tsx",
          lineNumber: 273,
          columnNumber: 13
        }, this),
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("section", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(AdminPaginatedTable_default, { columns, data: derbies, getRowKey: (row) => row.id, isLoading: fetcher.state === "loading", emptyMessage: 'No rice derbies yet. Use "Add rice derbies" to create one.', itemLabel: "rice derbies", pagination: {
      pageSize: 5
    } }, void 0, false, {
      fileName: "app/components/admin/RiceDerbiesModule.tsx",
      lineNumber: 296,
...
_s2(RiceDerbiesModule, "OYkXx+oWDCAZwuzxcyOdyYIwPd0=", false, function() {
  return [useAdminToast];
});
...
//# sourceMappingURL=/build/_shared/chunk-PWEZSQ62.js.map
