...
var DialogPortal = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React24.Children.map(children, (child) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1781440713938.0403";
}
var Dialog2 = Dialog;
...
var DialogOverlay2 = React25.forwardRef(_c = ({
  className,
  ...props
}, ref) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(DialogOverlay, { ref, className: cn("fixed inset-0 z-50 bg-black/50 backdrop-blur-sm data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:pointer-events-none", className), ...props }, void 0, false, {
...
var DialogContent2 = React25.forwardRef(_c3 = ({
  ...
  /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(DialogContent, { ref, className: cn("fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border bg-background p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] data-[state=closed]:pointer-events-none sm:rounded-3xl", className), ...props, children: [
    children,
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(DialogClose, { className: "absolute right-4 top-4\r\n             rounded-full bg-black/30 shadow-md p-2\r\n             hover:bg-black/40 transition\r\n             focus:outline-none", children: [
...
var DialogTitle2 = React25.forwardRef(_c7 = ({
  className,
  ...props
}, ref) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(DialogTitle, { ref, className: cn("text-lg font-semibold leading-none tracking-tight text-green-500", className), ...props }, void 0, false, {
  fileName: "app/components/ui/dialog.tsx",
  lineNumber: 70,
  columnNumber: 12
}, this));
...
var DialogDescription2 = React25.forwardRef(_c9 = ({
  className,
  ...props
}, ref) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(DialogDescription, { ref, className: cn("text-sm text-muted-foreground", className), ...props }, void 0, false, {
  fileName: "app/components/ui/dialog.tsx",
  lineNumber: 76,
  columnNumber: 12
}, this));
