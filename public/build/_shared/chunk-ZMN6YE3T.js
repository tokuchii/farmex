...
async function __PRIVATE_onWatchStreamChange(e, t, n) {
  ...
  else if (t instanceof __PRIVATE_DocumentWatchChange ? e.pa.Xe(t) : t instanceof __PRIVATE_ExistenceFilterChange ? e.pa.st(t) : e.pa.tt(t), !n.isEqual(SnapshotVersion.min()))
    try {
...
async function __PRIVATE_syncEngineUnlisten(e, t, n) {
  ...
  if (s.length > 1)
    return r.Vu.set(i.targetId, s.filter((e2) => !__PRIVATE_queryEquals(e2, t))), void r.Au.delete(t);
...
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  ...
  for (const r of e.Vu.get(t))
    e.Au.delete(r), n && e.Ru.Du(r, n);
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r of n)
    if (r instanceof __PRIVATE_AddedLimboDocument)
      e.gu.addReference(r.key, t), __PRIVATE_trackLimboChange(e, r);
...
@firebase/firestore/dist/index.esm.js:
   ...
   *)
*/
//# sourceMappingURL=/build/_shared/chunk-ZMN6YE3T.js.map
