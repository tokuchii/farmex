...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1779330085954.06";
}
var Dialog2 = Root;
...
var DialogOverlay2 = React25.forwardRef(_c = ({
  className,
  ...props
}, ref) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Overlay, { ref, className: cn("fixed inset-0 z-50 bg-black/50 backdrop-blur-sm data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0", className), ...props }, void 0, false, {
...
//# sourceMappingURL=/build/_shared/chunk-6UOKIDRU.js.map
